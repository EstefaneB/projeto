 ...
 */
  ...
  $retorno = $conexao->prepare('SELECT * FROM empresa');
  $retorno->execute();
                  ...
                  <tr>
                    ...
                    <td>
                      <form method="POST" action="crudEmpresa.php">
                        <input name="id" type="hidden" value="<?php echo $value['id']; ?>" />
                        <button class="custom-button" name="editar_layout" type="submit">Editar Layout</button>
                      </form>
                    </td>
                  </tr>
                <?php } ?>
