...
<body>
    <div class="sidebar">
        <a href="../Empresa/editar_layout.php"><i class="fas fa-users-cog"></i> Sua Empresa</a>
              ...
              <tbody>
                <?php foreach ($retorno->fetchAll() as $value) { ?>
                  <tr>
                    ...
                    <td>
                      <form method="POST" action="altAdm_Empresa.php">
                        <input name="id" type="hidden" value="<?php echo $value['id']; ?>" />
                        <button class="custom-button" name="alterar" type="submit">Alterar</button>
                      </form>
                    </td>
                    <td>
                      <form method="GET" action="crudAdm_Empresa.php">
                        <input name="id" type="hidden" value="<?php echo $value['id']; ?>" />
